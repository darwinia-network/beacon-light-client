...
e2e-test:; @forge script script/LightClientTest.s.sol:LightClientTest --rpc-url http://127.0.0.1:7777 --broadcast --legacy --private-key 0xfc6c309495809b69ce77b3250cacfef94d28698d8fb425501a59836fe30fab1d -vvvv --optimize --optimizer-runs 200
